 ...
 * @version $Id$
 */
public class colladaLoader extends ApplicationTemplate
{
    ...
    public static void main(String[] args)
    {
        ...
        new WorkerThread(new File("models/Batman.dae"),Position.fromDegrees(40.009993372683, -105.272774533734, 300), af).start();
